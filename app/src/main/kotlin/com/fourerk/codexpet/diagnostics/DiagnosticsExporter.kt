...
object DiagnosticsExporter {
    fun build(
        ...
        root.put("listener", JSONObject()
            ...
            .putNullable("lastHeartbeatAt", listener.lastHeartbeatAt)
            .put("consecutiveScanFailures", listener.consecutiveScanFailures)
            .put("rebindAttempts", listener.rebindAttempts)
        ...
        root.put("settings", JSONObject()
            ...
            .put("bubbleScale", settings.bubbleScale.toDouble())
            .put("maxVisibleBubbles", settings.maxVisibleBubbles)
            ...
            .put("autoUpdateEnabled", settings.autoUpdateEnabled)
            .put("autoDownloadUpdates", settings.autoDownloadUpdates)
            .put("updateWifiOnly", settings.updateWifiOnly)
            .put("lastUpdateCheckAt", settings.lastUpdateCheckAt)
        ...
        root.put("privacy", JSONObject()
            ...
            .put("networkPurpose", "GitHub stable update check/download only"))
